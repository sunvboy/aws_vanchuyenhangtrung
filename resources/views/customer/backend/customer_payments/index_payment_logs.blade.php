                ...
                <tbody>
                    ...
                    <tr class="odd" id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="whitespace-nowrap">
                            {{number_format($v->price_old,'0',',','.')}}
                        </td>
                        @if($v->price_final-$v->price_old < 0) <td class="whitespace-nowrap font-bold text-danger">{{number_format($v->price_final-$v->price_old,'0',',','.')}}</td>
                            @else
                            <td class="whitespace-nowrap font-bold text-success">+ {{number_format($v->price_final-$v->price_old,'0',',','.')}}</td>
                            @endif
                            <td class="whitespace-nowrap font-bold">
                                {{number_format($v->price_final,'0',',','.')}}
                            </td>
                            <td class="whitespace-nowrap">
                                {{$v->created_at}}
                            </td>
