    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-[30px]">
            <div class="md:col-span-5">
                <h2 class="font-bold text-xl mb-8">{{$fcSystem['homepage_company']}}</h2>
                ...
                <div class="space-y-3">
                    <div class="flex space-x-2 items-center">
                        ...
                        <div class="flex-1"><span>{{$fcSystem['contact_address']}} </span></div>
                    </div>
                    <div class="flex space-x-2 items-center">
                        <div class="w-[30px] h-[30px] flex items-center justify-center bg-primary rounded-full">
                            <i class="fa fa-envelope text-white"></i>
                        </div>
                        <div class="flex-1"><span>{{$fcSystem['contact_email']}}</span></div>
                    </div>
                    <div class="flex space-x-2 items-center">
                        <div class="w-[30px] h-[30px] flex items-center justify-center bg-primary rounded-full">
                            <i class="fa fa-phone text-white"></i>
                        </div>
                        <div class="flex-1"><span>{{$fcSystem['contact_hotline']}}</span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="md:col-span-3">
                <h2 class="font-bold text-xl mb-8">{{$item->title}}</h2>
                <ul class="space-y-2">
                    @foreach($item->children as $child)
                    <li><a href="{{url($child->slug)}}ss" class="hover:text-primary">{{$child->title}}</a></li>
                    @endforeach
                </ul>
            </div>
            @endif
            ...
            <div class="md:col-span-4">
                <div class="space-y-10">
                    ...
                    <div class="flex">
                        <div class="w-[55px]">
                            <img src="{{asset($fcSystem['contact_icon_hotline'])}}" alt="telephone">
                        </div>
                        <div class="flex-1 pl-[15px]">
                            <p class="font-bold">
                                Liên hệ Hotline: {{$fcSystem['contact_time']}}
                            </p>
                            <a class="font-bold text-f28" href="tel:{{$fcSystem['contact_hotline']}}">{{$fcSystem['contact_hotline']}}
                            </a>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="flex-1 flex gap-3">
                            <a href="{{$fcSystem['homepage_ios']}}" target="_blank" class="w-1/2">
                            ...
                            <a href="{{$fcSystem['homepage_android']}}" target="_blank" class="w-1/2">
