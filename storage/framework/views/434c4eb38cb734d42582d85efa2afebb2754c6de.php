                                                    ...
                                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr class="border-b dark:border-neutral-500">
                                                            ...
                                                            <td class="whitespace-nowrap  py-4 font-bold"
                                                                <?php if($v->type == 'plus'): ?> style="color:#04AA6D"
                                                                <?php else: ?> style="color:#f44336" <?php endif; ?>> <?php if($v->type == 'plus'): ?>
                                                                    + <?php else: ?>
                                                                    - <?php endif; ?> <?php echo e(number_format($v->price,'0',',','.')); ?></td>
                ...
                <div class="p-6">
                    ...
                    <div class="step-2 hidden">
                        ...
                        <div>
                            ...
                            <div>
                                HOTLINE/ZALO : <a href="tel:<?php echo e($fcSystem['contact_hotline']); ?>"
                                                  class="font-bol text-red-600 font-bold"> <?php echo e($fcSystem['contact_hotline']); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/vanchuyenhangtrung.com/resources/views/customer/frontend/customer_payments/index.blade.php ENDPATH**/ ?>