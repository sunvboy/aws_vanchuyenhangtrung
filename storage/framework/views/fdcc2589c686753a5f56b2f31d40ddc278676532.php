                    ...
                    <div class="p-6 bg-white ">
                        ...
                        <div class="relative py-3">
                            <ul class="ul-tab flex items-center gap-5">
                                <li class="py-2 tab-profile active"><a href="javascript:void(0)" onclick="tab('profile')"><?php echo e(trans('index.AccountInformation')); ?></a></li>
                        ...
                        <div id="tab-profile" class="tab-box active">
                            <form id="form-information">
                                ...
                                <div class="grid md:grid-cols-1 gap-4 mt-4">
                                    ...
                                    <div>
                                        <span class="font-bold text-xs mb-1 block">Địa chỉ<span class="text-f13 text-red-600">*</span></span>
                                        <input autocomplete="off" type="text" name="address" value="<?php echo e($detail->address); ?>" class="w-full border border-gray-300 rounded-md  px-4 h-12 ">
                                    </div>
                                </div>
                                <div class="grid md:grid-cols-2  gap-4 mt-6">
                                    <button class="js_submit_information font-bold h-12 w-full text-white bg_gradient flex-1 cursor-pointer items-center inline-flex rounded-md px-6 justify-center text-[16px]">
                        ...
                        <div id="tab-change-password" class="tab-box hidden">
                            <form id="form-password">
                                ...
                                <div class="grid grid-cols-2 gap-4 mt-6">
                                    <button class="js_submit_password bg_gradient h-12 w-full text-white bg-global flex-1 cursor-pointer items-center inline-flex rounded-md px-6 justify-center text-[16px]">
                                        <?php echo e(trans('index.SaveChanges')); ?>
...
<script type="text/javascript">
    $('.menu_item_auth:eq(0)').addClass('active')
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\vanchuyenhangtrung.local\resources\views/customer/frontend/manager/information.blade.php ENDPATH**/ ?>