            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td class="whitespace-nowrap">
                            <b>Tên ngân hàng: </b> {{$v->bank}}<br>
                            <b>Chủ tài khoản: </b> {{$v->bank_name}}<br>
                            <b>Số tài khoản: </b> {{$v->bank_number}}<br>
                            <b>Chi nhánh: </b> {{$v->bank_address}}
                        </td>
                        <td class="whitespace-nowrap">
                            {{$v->created_at}}
                        </td>
                        <td class="whitespace-nowrap">
                            ...
                            <span class="flex items-center mr-3 btn btn-success btn-sm text-white ">
                                Thành công
                            </span>
                            @elseif($v->status == 'canceled')
                            <span class="flex items-center mr-3 btn btn-danger btn-sm ">
                                Từ chối
                            </span>
                            @endif
                        </td>
                        <td class="table-report__action">
                            ...
                            <div class="flex">
                                ...
                                <a class="flex items-center mr-3 btn btn-danger js_updateMoneyMinus" href="javascript:void(0)" data-id="{{$v->id}}" data-type="canceled">
                                    Từ chối
                                </a>
                            </div>
                            @endcan
        ...
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo route('money_minuses.update'); ?>",
                        headers: {
