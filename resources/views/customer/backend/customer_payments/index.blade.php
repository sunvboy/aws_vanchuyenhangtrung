    ...
    <div class="content ">
        <div class="flex justify-between mt-5">
            ...
            <div class="flex items-center space-x-2">
                @can('customer_payments_create')
                    <a href="{{route('customer_payments.create',['type' => 'plus'])}}"
                       class="btn btn-primary shadow-md">Thêm mới</a>
                    <a href="{{route('customer_payments.minus',['type' => 'minus'])}}" class="btn btn-danger shadow-md">Trừ
                        tiền</a>
                @endcan
                <a href="{{route('customer_payments.export',[
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            ...
            <div class=" col-span-12 lg:col-span-12">
                <table class="table table-report -mt-2">
                    ...
                    <tbody>
                    @foreach($data as $v)
                        <tr class="odd @if($v->type == 'plus') btn-success @else btn-danger @endif"
                                ...
                                <div class="flex justify-center items-center">
                                    ...
                                    @can('customers_edit')
                                        <a class="flex items-center mr-3"
                                           href="{{ route('customer_payments.edit',['id'=>$v->id]) }}">
