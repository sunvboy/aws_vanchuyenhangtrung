                        ...
                        <ul class="folder-list" id="folder-list" style="padding: 0">
                            ...
                            <li class="mt-2">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div>
                                        <a type="button" class="slide-group-edit text-danger mr-2" href="javascript:void(0)" data-id="<?php echo e($v->id); ?>" data-title="<?php echo e($v->title); ?>" data-tw-toggle="modal" data-tw-target="#basic-modal-edit-group"> Sửa</a>
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\vanchuyenhangtrung.local\resources\views/slide/backend/index.blade.php ENDPATH**/ ?>