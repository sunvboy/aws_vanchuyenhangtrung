...
<div class="content ">
    <div class="flex justify-between items-center mt-5">
        ...
        <div class="flex">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('warehouses_create')): ?>
            <a href="<?php echo e(route('warehouses.create')); ?>" class="btn btn-primary shadow-md mr-2"><?php echo e(trans('admin.create')); ?></a>
            <?php endif; ?>
            <a href="<?php echo e(route('warehouses.export',['customer_id' => request()->get('customer_id'),'date_start'=>request()->get('date_start'),'date_end'=>request()->get('date_end'),'keyword'=>request()->get('keyword')])); ?>" class="btn btn-primary shadow-md text-white hidden">Export excel</a>
    ...
    <div class="grid grid-cols-12 gap-6 mt-2">
        ...
        <div class=" col-span-12 lg:col-span-12">
            <?php echo $__env->make('warehouses.backend.data',['action' => 'index'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!-- END: Data List -->
        <!-- BEGIN: Pagination -->
...
<!-- end: loading -->
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\vanchuyenhangtrung.local\resources\views/warehouses/backend/index.blade.php ENDPATH**/ ?>