<label class="form-label text-base font-semibold">Ảnh đại diện 頭像</label>
<div class="flex items-center space-x-3">
    <?php if($action == 'profile'): ?>
    <img src="<?php echo e(File::exists(base_path(Auth::user()->image)) ? asset(Auth::user()->image) : 'https://ui-avatars.com/api/?name='.Auth::user()->name); ?>" id="mainThmb-image" class="mb-3 w-44 h-44 rounded-full" style="height:176px;object-fit: cover;">
    <input type="hidden" name="image_old" value="<?php echo e(!empty(Auth::user()->image)?Auth::user()->image:''); ?>">
    <?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\vanchuyenhangtrung.local\resources\views/user/backend/user/image.blade.php ENDPATH**/ ?>