...
<div class="content hidePrint">
    <div class="flex justify-between items-center mt-5">
        ...
        <div class="flex">
            ...
            <a href="{{route('packaging_v_n_s.create')}}" class="btn btn-primary shadow-md mr-2">{{trans('admin.create')}}</a>
            @endcan
            <a href="{{route('packaging_v_n_s.export',['date_start'=>request()->get('date_start'),'date_end'=>request()->get('date_end'),'keyword'=>request()->get('keyword')])}}" class="btn btn-primary mr-2 shadow-md text-white btn-excel">Export excel</a>
            <a href="{{route('packaging_v_n_s.export_compact',['date_start'=>request()->get('date_start'),'date_end'=>request()->get('date_end'),'keyword'=>request()->get('keyword')])}}" class="btn btn-success mr-2 shadow-md text-white btn-excel-index">Export excel</a>
        </div>
    </div>
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td>
                            <a target="_blank" href="{{route('packagings.show',['id' => $v->packagings->id])}}" class="text-primary font-bold" style="text-decoration: underline;">Mã vận đơn</a>
                        </td>
                        <td>
                            {{count($v->packagings->packaging_relationships)}}
                        </td>
                        <td>
                            {{!empty($v->packagings)?$v->packagings->value_quantity:count($v->packagings->packaging_relationships)}}
                        </td>
                        <td>
                            {{$v->packagings->value_weight}}
                        </td>
                        ...
                        <td class="">
                            ...
                            <div class="flex justify-center items-center">
                                ...
                                @can('packaging_v_n_s_edit')
                                <a class="flex items-center mr-3 hidden" href="{{ route('packaging_v_n_s.edit',['id'=>$v->id]) }}">
                                    <i data-lucide="check-square" class="w-4 h-4 mr-1"></i>
                                    Edit
                                </a>
                                @endcan
                                @can('packaging_v_n_s_destroy')
