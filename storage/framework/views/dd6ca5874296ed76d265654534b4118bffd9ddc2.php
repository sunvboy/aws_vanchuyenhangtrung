...
<nav class="side-nav">
    ...
    <div class="scrollable">
        <ul class="scrollable__content">
            ...
            <?php else: ?>
            <li>
                <a href="<?php echo e(route($item['route'])); ?>" class="side-menu <?php echo e(activeMenu(''.$key.'')); ?>">
            ...
            <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php /* <!-- Start: Cấu hình hệ thống -->
            @can('warehouses_index')
            <li>
                <a href="{{route('warehouses.search')}}" class="side-menu {{ activeMenu('warehouses') }}">
                    <div class="side-menu__icon"> <i data-lucide="box"></i> </div>
                    <div class="side-menu__title">
                        Tra cứu mã vận đơn
                    </div>
            ...
            @endcan
            @can('packagings_index')
            <li>
                <a href="{{route('packagings.search')}}" class="side-menu {{ activeMenu('packagings-search') }}">
                    <div class="side-menu__icon"> <i data-lucide="box"></i> </div>
                    <div class="side-menu__title">
                        Tra cứu mã bao
                    </div>
...
</nav><?php /**PATH D:\xampp\htdocs\vanchuyenhangtrung.local\resources\views/dashboard/common/sidebar.blade.php ENDPATH**/ ?>