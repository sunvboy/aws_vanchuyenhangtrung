...
<div class="content">
    <div class=" flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="<?php echo e(route('admin.profile-password')); ?>" class="btn btn-primary shadow-md mr-2">
    ...
    <form role="form" action="<?php echo e(route('admin.profile-store' , ['id' => Auth::user()->id])); ?>" method="post" enctype="multipart/form-data">
        <div class="grid grid-cols-12 gap-5 mt-5">
                ...
                <div class="box  p-5">
                    ...
                    <div>
                        <div class="flex border-b border-slate-200 border-dashed pb-5 mb-5 last:border-b-0 last:pb-0 last:mb-0">
                            <img class=" rounded-full bg-slate-200 dark:bg-darkmode-400 flex items-center justify-center text-base font-medium" src="<?php echo e(!empty(Auth::user()->image)?url(Auth::user()->image):asset('images/404.png')); ?>" alt="user image" style="width: 100px;height: 100px;object-fit: cover;">
                            <div>
                                <div class="ml-5">
                                    <div class="font-medium text-base">Họ và tên</div>
                                    <div class=" text-slate-500"><?php echo e(Auth::user()->name); ?></div>
                                </div>
                                <div class="ml-5 mt-1">
                                    <div class="font-medium text-base">Email</div>
                                    <div class=" text-slate-500"><?php echo e(Auth::user()->email); ?></div>
                                </div>
                                <div class="ml-5 mt-1">
                                    <div class="font-medium text-base">Địa chỉ</div>
                                    <div class=" text-slate-500"><?php echo e(Auth::user()->address); ?></div>
                                </div>
                                <div class="ml-5 mt-1">
                                    <div class="font-medium text-base">Số điện thoại</div>
                                    <div class=" text-slate-500"><?php echo e(Auth::user()->phone); ?></div>
            ...
            <div class="col-span-12 xl:col-span-8">
                <div class=" box p-5">
                    ...
                    <div class="mt-3">
                        <?php echo $__env->make('user.backend.user.image',['action' => 'profile'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/vanchuyenhangtrung.com/resources/views/user/backend/user/profile.blade.php ENDPATH**/ ?>