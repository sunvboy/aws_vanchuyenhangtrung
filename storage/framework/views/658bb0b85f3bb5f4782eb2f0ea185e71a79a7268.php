                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-neutral-500">
                                    ...
                                    <td class="whitespace-nowrap  py-4 ">
                                        <a href="<?php echo e(route('deliveryHome.detail',['id' => $v->id])); ?>" class="text-red-600 font-bold" style="text-decoration: underline;"><?php echo e($v->code); ?></a>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap  py-4">
                                        ...
                                        <button class="text-white px-2 py-1 rounded text-xs bg-red-600">#<?php echo e($v->code_merge); ?></button>
                                        <?php endif; ?>
                                    </td>
                                    <td class="whitespace-nowrap  py-4">
                                        <?php if($v->status == 'wait'): ?>
                                        <a href="javascript:void(0)" style="text-decoration: underline;" data-status="<?php echo e($v->status); ?>" data-image="" data-code="<?php echo e($v->code); ?>" data-id="<?php echo e($v->id); ?>" data-price="<?php echo e(floor($v->price)); ?>" class="ja_modalPayment  ja_modalPayment_<?php echo $v->id ?> text-white px-2 py-1 rounded text-xs bg-primary" href="javascript:void(0)">Thanh toán</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
        ...
        <div class="relative bg-white shadow dark:bg-gray-700">
            ...
            <div class="p-6">
                ...
                <div>
                    ...
                    <div>
                        HOTLINE/ZALO : <a href="tel:<?php echo e($fcSystem['contact_hotline']); ?>" class="font-bol text-red-600 font-bold"> <?php echo e($fcSystem['contact_hotline']); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/vanchuyenhangtrung.com/resources/views/delivery/frontend/index.blade.php ENDPATH**/ ?>