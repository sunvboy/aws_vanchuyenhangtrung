...
<div class="content">
    ...
    <form id="formMinus" class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('money.store.minus')}}" method="post" enctype="multipart/form-data">
...
<script>
    $(document).on('click', '.btn-minus', function(e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: "<?php echo route('money.validate') ?>",
            data: {
