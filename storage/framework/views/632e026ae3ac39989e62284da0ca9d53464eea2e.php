 <table class="table table-report">
     <thead class="table-dark">
         <tr>
             <td colspan="2" class="text-center font-bold" style="    border-radius: 0px;color: #000">Tổng dòng : <?php echo e(!empty($count)?$count : 0); ?> </td>
             <td class=" text-white" style="background-color: red">Tổng cân </td>
             <td class=" text-white font-bold" style="background-color: red;border-radius: 0px;"><?php echo e($total); ?></td>
     ...
     <tbody>
         ...
         <tr class="odd " id="post-<?php echo $v->id; ?>">
             ...
             <td>
                 <a href="<?php echo e(route('warehouses.show',['id'=>$v->id])); ?>" class="text-danger font-bold" style="text-decoration: underline;"><?php echo e($v->code_cn); ?></a>
             </td>
             <td>
             ...
             <td>
                 <?php echo e(!empty($v->customer->code)?$v->customer->code:''); ?>

             </td>

             <td>
                 <?php if(!empty($v->packaging_relationships) && !empty($v->packaging_relationships->packagings)): ?>
                 <a target="_blank" href="<?php echo e(route('packagings.show',['id' =>  $v->packaging_relationships->packaging_id])); ?>" class="text-primary font-bold" style="text-decoration: underline;">
             ...
             <td class="table-report__action">
                 <div class="flex justify-center items-center">
                     <a class="flex items-center mr-3" href="javascript:void(0)" onclick="getinfo(<?php echo e($v->id); ?>,'<?php echo e(!empty($v->customer->code)?$v->customer->code:''); ?>')">
                         <i data-lucide="printer" class="w-6 h-6 mr-1 text-primary"></i>
                     </a>
                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('warehouses_edit')): ?>
                     <a class="flex items-center mr-3" href="<?php echo e(route('warehouses.edit',['id'=>$v->id])); ?>">
                         <i data-lucide="check-square" class="w-6 h-6 mr-1"></i>
                         Edit
                     </a>
                     <?php endif; ?>
                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('warehouses_destroy')): ?>
 ...
 <?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\vanchuyenhangtrung.local\resources\views/warehouses/backend/data.blade.php ENDPATH**/ ?>