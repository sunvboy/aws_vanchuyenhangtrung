...
class CategoryArticle extends Model
{
    ...
    {
        return $this->hasMany(CataloguesRelationship::class, 'catalogueid')->where('module', '=', 'articles');
    }
    ...
    public function posts()
    {
        return $this->hasMany(CataloguesRelationship::class, 'catalogueid')->where('module', '=', 'articles')
            ...
            ->select('id', 'title', 'slug', 'description', 'image', 'articles.created_at', 'catalogues_relationships.catalogueid')
            ->orderBy('articles.order', 'asc')->orderBy('articles.id', 'desc')->limit(10);
    }
}
