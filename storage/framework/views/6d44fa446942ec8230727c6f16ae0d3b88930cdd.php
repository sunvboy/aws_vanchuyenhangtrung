<div class="top-bar">
            ...
            <div class="notification-content__box dropdown-content">
                ...
                <div class="cursor-pointer relative flex ">
                    <div class="w-10 h-10 flex-none image-fit mr-1">
                        <img alt="Rocketman - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('backend/images/profile-5.jpg')); ?>">
                ...
                <div class="cursor-pointer relative flex mt-5">
                    <div class="w-10 h-10 flex-none image-fit mr-1">
                        <img alt="Rocketman - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('backend/images/profile-14.jpg')); ?>">
                        <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600">
                        </div>
                    </div>
                    <div class="ml-2">
                ...
                <div class="cursor-pointer relative flex mt-5">
                    <div class="w-10 h-10 flex-none image-fit mr-1">
                        <img alt="Rocketman - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('backend/images/profile-3.jpg')); ?>">
                        <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600">
                        </div>
                    </div>
                    <div class="ml-2">
    ...
    <!-- END: Notifications -->
    <!-- BEGIN: Notifications -->
    <div class=" mr-auto sm:mr-6 hidden">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu w-40">
                    <ul class="dropdown-content">
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(route('components.language', [$key])); ?>"><?php echo e($item['title']); ?></a></li>
    ...
    <div class=" dropdown text-slate-200 h-10">
        <div class="h-full dropdown-toggle flex items-center" role="button" aria-expanded="false" data-tw-toggle="dropdown">
            <div class="w-10 h-10 image-fit">
                <img alt="<?php echo e(!empty(Auth::user())?Auth::user()->name:''); ?>" class="rounded-full border-2 border-white border-opacity-10 shadow-lg" src="<?php echo e(asset('backend/images/profile-14.jpg')); ?>">
            </div>
        ...
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content">
                <li>
                    <a href="<?php echo e(route('admin.profile')); ?>" class="dropdown-item"> <i data-lucide="user" class="w-4 h-4 mr-2"></i> Hồ sơ cá nhân </a>
                </li>

                <li>
                    <a href="<?php echo e(route('admin.profile-password')); ?>" class="dropdown-item"> <i data-lucide="lock" class="w-4 h-4 mr-2"></i> Đổi mật khẩu
                    </a>
                </li>
                ...
                <li>
                    <a href="<?php echo e(route('admin.logout')); ?>" class="dropdown-item"> <i data-lucide="toggle-right" class="w-4 h-4 mr-2"></i> Logout
                    </a>
                </li>
            </ul>
        </div>
    </div>
</div><?php /**PATH D:\xampp\htdocs\vanchuyenhangtrung.local\resources\views/dashboard/common/header.blade.php ENDPATH**/ ?>