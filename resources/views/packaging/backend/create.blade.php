        ...
        <table class="table table-report -mt-2">
            ...
            <tbody>
                <tr class="odd " id="post-<?php echo $v->id; ?>">
                    ...
                    <td>
                        <a href="{{route('packagings.show',['id' => $detail->id])}}" class="text-danger font-bold">{{$detail->code}}</a>
                    </td>
                    <td>
                        <a href="{{route('packagings.show',['id' => $detail->id])}}" class="text-primary font-bold" style="text-decoration: underline;">Mã vận đơn</a>
                    </td>
                    <td>
                        {{$detail->total_weight}}
                    </td>
            ...
            <tbody>
                <tr>
                    <td style="border:1px solid #000;font-size:18px">
                        ...
                        <p style="font-size:18px;text-align:center" class="makhachprint">{{!empty($detail->customer) ?$detail->customer->code:''}} - {{!empty($detail->customer) ?$detail->customer->name:''}} / {{number_format((float)$detail->value_weight, 2, '.', '')}} kg</p>
                        <p style="font-size:18px;text-align:center" class=""> Số kiện: <span id="sokien">{{$detail->packaging_relationships->count()}}</span></p>
                    </td>
                </tr>
                <tr>
                    <td></td>
