...
class ArticleController extends Controller
{
    ...
    public function index($slug = "")
    {
        ...
        $sameArticle =  $sameArticle->limit(4)->get();
        //cập nhập lượt xem
        ...
        return view('article.frontend.article.index', compact('module', 'fcSystem', 'detail', 'seo', 'breadcrumb', 'sameArticle', 'catalogues', 'previous', 'next'));
    }
}
