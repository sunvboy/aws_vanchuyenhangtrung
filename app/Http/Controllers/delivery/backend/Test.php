...
//        die;
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($id)) {
            ...
            $body = "Đơn hàng $request->code của bạn vẫn đang trong quá trình vận chuyển và dự kiến được giao trong 1-2 ngày tới. Vui lòng đừng bỏ qua thông báo nếu bạn đã nhận được hàng nhé.";
    ...
    {
        $detail = Delivery::with('customer')->where('deleted_at', null)->find($request->id);
