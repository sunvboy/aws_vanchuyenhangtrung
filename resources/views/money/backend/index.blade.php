...
<div class="content ">
    <div class="flex justify-between mt-5">
        ...
        <div class="flex items-center space-x-2">
            @can('money_create')
            <a href="{{route('money.create',['type' => 'plus'])}}" class="btn btn-primary shadow-md">Thêm mới</a>
            <a href="{{route('money.minus',['type' => 'minus'])}}" class="btn btn-danger shadow-md">Trừ tiền</a>
            @endcan
            <a href="{{route('money.export',[
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="col-span-12 mt-2">
            <form action="" class="grid grid-cols-12 gap-2" id="search" style="margin-bottom: 0px;">
                ...
                <div class="col-span-2 hidden">
                    <select class="form-control ajax-delete-all-customer-payments h-10" data-title="Lưu ý: Khi bạn xóa danh mục nội dung tĩnh, toàn bộ nội dung tĩnh trong nhóm này sẽ bị xóa. Hãy chắc chắn rằng bạn muốn thực hiện chức năng này!" data-module="{{$module}}">
        ...
        <div class=" col-span-12 lg:col-span-12">
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    @foreach($data as $v)
                    <tr class="odd @if($v->type == 'plus') btn-success @else btn-danger @endif" id="post-<?php echo $v->id; ?>">
                        <td class="hidden">
                        ...
                        <td class="whitespace-nowrap">
                            @if($v->type == 'plus') + @else - @endif {{number_format($v->price,'0',',','.')}}
                        </td>
                        <td class="whitespace-nowrap">
                        ...
                        <td class="table-report__action w-56 hidden">
                            <div class="flex justify-center items-center">
                                @can('customers_edit')
                                <a class="flex items-center mr-3" href="{{ route('money.edit',['id'=>$v->id]) }}">
...
<script>
    ...
    function loadIDS() {
        ...
        $('.btn-excel').attr('href', '<?php echo route('money.export') ?>?ids=' + ids)
    }
