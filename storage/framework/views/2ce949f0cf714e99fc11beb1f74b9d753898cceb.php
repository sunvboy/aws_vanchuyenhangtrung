                ...
                <table class="table table-report -mt-2">
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="odd " id="post-<?php echo $v->id; ?>">
                            ...
                            <td>
                                <a href="<?php echo e(route('notifications.show',['id' => $v->id])); ?>"
                                   class="font-bold text-primary" style="text-decoration: revert;"><?php echo e($v->title); ?></a>
                            </td>
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/vanchuyenhangtrung.com/resources/views/notification/index.blade.php ENDPATH**/ ?>