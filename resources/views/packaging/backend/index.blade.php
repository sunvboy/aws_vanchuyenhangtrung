...
<div class="content hidePrint">
    ...
    <div class="flex justify-between items-center mt-5">
        ...
        <div class="flex">
            ...
            @can('packagings_create')

            <a href="{{route('packagings.create')}}" class="btn btn-primary shadow-md mr-2">{{trans('admin.create')}}</a>

            @endcan

            <a href="{{route('packagings.export',['packaging_v_n_s' => request()->get('packaging_v_n_s'),'customer_id' => request()->get('customer_id'),'date_start'=>request()->get('date_start'),'date_end'=>request()->get('date_end'),'keyword'=>request()->get('keyword'),'packaging_v_n_s'=>request()->get('packaging_v_n_s')])}}" class="btn btn-success mr-2 shadow-md text-white btn-excel">Export excel</a>
            ...
            <table class="table table-report -mt-2">
                ...
                <thead class="table-dark">
                    ...
                    <tr>
                        ...
                        <td class=" text-black font-bold" style="background-color: yellow;border-radius: 0px;color:black">{{number_format((float)$total_value_weight, 2, '.', '')}}</td>
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="">
                            ...
                            <div style="display: none;">
                                ...
                                <textarea class="textareacopy-{{$v->id}}">@if(!empty($v->packaging_relationships) && count($v->packaging_relationships) > 0)@foreach($v->packaging_relationships as $item){{$item->code_vn}}&#13;&#10;@endforeach @endif</textarea>

                            </div>

                            <div class="flex justify-center items-center">

                                <a class="flex items-center mr-3" href="javascript:void(0)" onclick="getinfo({{$v->id}})">

                                    <i data-lucide="printer" class="w-8 h-8 mr-1"></i> Print

                                </a>

                                <a class="flex items-center mr-3" href="javascript:void(0)" onclick="copyToClipboard('.textareacopy-{{$v->id}}')">
                                ...
                                @can('packagings_edit')
                                @if(!empty($v->products))
                                    <a class="flex items-center mr-3" href="{{ route('packagings.edit',['id'=>$v->id]) }}">
                                ...
                                @else
                                        <a class="flex items-center mr-3" href="{{ route('packagings.advanced',['id'=>$v->id]) }}">
