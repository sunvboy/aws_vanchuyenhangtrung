    ...
    <div class="content hidePrint">
        <div class="flex justify-between items-center mt-5">
            ...
            <div class="flex">
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('packaging_trucks.export',['date_start'=>request()->get('date_start'),'date_end'=>request()->get('date_end'),'keyword'=>request()->get('keyword')])); ?>" class="btn btn-success mr-2 shadow-md text-white btn-excel">Export excel</a>
            </div>
        </div>
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/api/resources/views/packaging/truck/index.blade.php ENDPATH**/ ?>