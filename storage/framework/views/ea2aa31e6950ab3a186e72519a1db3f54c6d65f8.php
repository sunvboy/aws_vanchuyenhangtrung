        ...
        <div class="flex justify-between items-center mt-5">
            ...
            <div class="flex">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('packaging_v_n_s_create')): ?>
                    <a href="<?php echo e(route('packaging_trucks.create')); ?>" class="btn btn-primary shadow-md mr-2"><?php echo e(trans('admin.create')); ?></a>
                <?php endif; ?>
                    <a href="<?php echo e(route('packaging_trucks.export',['date_start'=>request()->get('date_start'),'date_end'=>request()->get('date_end'),'keyword'=>request()->get('keyword')])); ?>" class="btn btn-primary mr-2 shadow-md text-white btn-excel">Export excel</a>

                    <a href="<?php echo e(route('packaging_trucks.exportCompact',['date_start'=>request()->get('date_start'),'date_end'=>request()->get('date_end'),'keyword'=>request()->get('keyword')])); ?>" class="btn btn-success mr-2 shadow-md text-white btn-excel">Export excel</a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="col-span-12 mt-2">
                <form action="" class="grid grid-cols-12 gap-2" id="search" style="margin-bottom: 0px;">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('packaging_trucks_destroy')): ?>
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/vanchuyenhangtrung.com/resources/views/packaging/truck/index.blade.php ENDPATH**/ ?>