        ...
        <div class="w-full min-h-screen p-5 md:p-20 flex items-center justify-center">
            <div class="w-96 ">
                <img class="mx-auto w-16" alt="Rocketman - Tailwind HTML Admin Template"
                    src="<?php echo e(asset('backend/images/logo.svg')); ?>">
                ...
                <div
                    ...
                    <form action="<?php echo e(route('admin.reset-password')); ?>" method="post" id="resetform">
                        ...
                        <div class="alert alert-success alert-dismissible show flex items-center mb-2" role="alert">
                            ...
                            <b class="mr-1">Success! </b> <?php echo e(session('success')); ?>
                        ...
                        <div class="alert alert-danger alert-dismissible show flex items-center mb-2" role="alert">
                            ...
                            <b class="mr-1">Error! </b> <?php echo e(session('error')); ?>
...
</style><?php /**PATH /home/quyenitc/vanchuyenhangtrung.com/resources/views/user/backend/auth/reset-password.blade.php ENDPATH**/ ?>