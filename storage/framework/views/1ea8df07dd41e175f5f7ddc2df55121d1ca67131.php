...
<title>Cấu hình giao hàng</title>
...
<div class="content">
    ...
    <form method="post" action="<?php echo e(route('general_orders.store')); ?>" class="form-horizontal box">
        <?php echo csrf_field(); ?>
        <div class="grid">
            <!-- BEGIN: Basic Tab -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/vanchuyenhangtrung.com/resources/views/general/order/index.blade.php ENDPATH**/ ?>