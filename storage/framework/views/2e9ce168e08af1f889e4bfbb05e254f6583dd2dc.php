...
<div class="content hidePrint">
    <div class="flex justify-between items-center mt-5">
        ...
        <div class="flex">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('packagings.export',['packaging_v_n_s' => request()->get('packaging_v_n_s'),'customer_id' => request()->get('customer_id'),'date_start'=>request()->get('date_start'),'date_end'=>request()->get('date_end'),'keyword'=>request()->get('keyword')])); ?>" class="btn btn-primary mr-2 shadow-md text-white btn-excel">Export excel</a>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="col-span-12 mt-2">
            <form action="" class="grid grid-cols-12 gap-2" id="search" style="margin-bottom: 0px;">
                ...
                <div class="col-span-2">
                    <?php echo Form::select('packaging_v_n_s', ['1' => 'Đã về VN', '2' => 'Nhập kho TQ'], request()->get('packaging_v_n_s'), ['class' => 'form-control h-10',  'autocomplete' => 'off', 'placeholder' => 'Trạng thái']); ?>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\vanchuyenhangtrung.local\resources\views/packaging/backend/index.blade.php ENDPATH**/ ?>