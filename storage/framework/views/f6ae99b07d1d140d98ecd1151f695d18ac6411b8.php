...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('roles.store')); ?>" method="post"
                ...
                <div class="grid grid-cols-12 ">
                    ...
                    <div class="col-span-12 xl:col-span-2">
                        <label for="check<?php echo e($val->id); ?>">
                            <input name="permission_id[]" type="checkbox" class="inputChild" value="<?php echo e($val->id); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/vanchuyenhangtrung.com/resources/views/user/backend/role/create.blade.php ENDPATH**/ ?>