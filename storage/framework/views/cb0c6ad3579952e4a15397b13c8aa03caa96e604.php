<?php $__env->startSection('title'); ?>
    ...
    <title>Tạo bao xếp xe Trung Quốc</title>
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    $array = array(
        ...
        [
            ...
            "title" => "Tạo bao xếp xe Trung Quốc",
    ...
    <script>
        ...
        $(document).on('keypress', '.js_code_packagings', function(e) {
            ...
            if (key == 13) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo route('packaging_trucks.detail') ?>",
                    type: "POST",
                    dataType: "JSON",
                    data: {
                        code: code,
        ...
        $(document).on('click', '.js_removeColumn', function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo route('packaging_trucks.destroy') ?>",
                type: "POST",
                dataType: "JSON",
                data: {
                    code: code,
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/api/resources/views/packaging/truck/create.blade.php ENDPATH**/ ?>