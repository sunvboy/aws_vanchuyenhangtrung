<div class="w-full md:w-[250px] lg:w-[376px] order-2 md:order-1 mt-10 md:mt-0 hidden lg:block">
    <div>
        ...
        <div class="flex flex-col gap-3">
            ...
            <a href="{{route('cartF.cart')}}" class="menu_item_auth flex justify-between items-center p-3 rounded-xl ">
            ...
            <a href="{{route('ordersF.index')}}" class="menu_item_auth flex justify-between items-center p-3 rounded-xl">
                <div class="flex space-x-2">
            ...
            <a href="{{route('customer_payment.frontend_index')}}" class="menu_item_auth flex justify-between items-center p-3 rounded-xl ">
                <div class="flex space-x-2">
            ...
            <a href="{{route('ordersF.index_payment_logs')}}" class="menu_item_auth flex justify-between items-center p-3 rounded-xl ">
                <div class="flex space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-global">
            ...
            <a href="{{url('danh-sach-ma-van-don')}}" class="menu_item_auth flex justify-between items-center p-3 rounded-xl ">
                <div class="flex space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-global">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                    </svg>
            ...
            <a href="{{url('danh-sach-bao')}}" class="menu_item_auth flex justify-between items-center p-3 rounded-xl ">
                <div class="flex space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-global">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                    </svg>
            ...
            <a href="{{route('deliveryHome.index')}}" class="menu_item_auth flex justify-between items-center p-3 rounded-xl ">
                <div class="flex space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-global">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                    </svg>
