                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 md:space-x-5 p-3 rounded-xl gap-1 md:gap-8 mb-5 bg-gray-100">
                                    ...
                                    <div>
                                        <div class="flex flex-wrap md:flex-col md:space-y-2 space-x-2 md:space-x-0">
                                            <a href="javascript:void(0)" class="text-white px-2 rounded text-xs h-9 leading-9 text-center mb-2 md:mb-0" style="background-color: <?php echo e(config('cart')['class'][$item->status]); ?>;">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\vanchuyenhangtrung.local\resources\views/customer/frontend/order/index.blade.php ENDPATH**/ ?>