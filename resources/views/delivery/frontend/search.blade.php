...
<main class="my-5">
    <div class="container mx-auto px-4 space-y-5">
        ...
        <form class="w-full flex flex-col md:flex-row justify-between space-y-4 md:space-y-0">
            ...
            <div class="w-28">
                <a href="{{route('deliveryHome.export',['code'=>request()->get('code')])}}" class="bg-[#5cb85c] rounded-lg h-[42px] w-full float-left flex items-center justify-center text-white">Xuất excel</a>
            </div>
        </form>
                        ...
                        <table class="min-w-full text-center text-sm font-light">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-neutral-500">
                                    ...
                                    <td class="whitespace-nowrap  py-4 "><a href="{{route('deliveryHome.detail',['id' => $v->id])}}" class="text-red-600 font-bold" style="text-decoration: underline;">{{$v->code}}</a></td>
