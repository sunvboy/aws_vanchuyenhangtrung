    ...
    <div class="box p-5 mt-5">
        ...
        <ol class="relative border-l border-gray-200 dark:border-gray-700">
            <li class="mb-3 ml-4">
                ...
                <p><i class="text-base font-normal">Người tạo: <span class="text-danger"><?php echo !empty($detail->user)?$detail->user->name:''; ?></span></i>
                </p>
                <p class="text-base font-normal">Tạo đơn xuất kho</p>
            </li>
            <?php if(!empty($detail->delivery_histories) && count($detail->delivery_histories) > 0): ?>
            <?php $__currentLoopData = $detail->delivery_histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="mb-3 ml-4">
                <div class="absolute w-3 h-3 bg-danger rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500"><?php echo e($item->created_at); ?></time>
                <p><i class="text-base font-normal">Người chỉnh sửa: <span class="text-danger"><?php echo !empty($item->user)?$item->user->name:''; ?></span></i>
                </p>
                <p class="text-base font-normal"><?php echo $item->note; ?></p>
            </li>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/vanchuyenhangtrung.com/resources/views/delivery/backend/edit.blade.php ENDPATH**/ ?>