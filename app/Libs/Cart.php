            ...
            $html .= '<li class="flex flex-wrap group mb-8 cart-' . $k . '" data-rowid="' . $k . '">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center space-x-2 mt-2">
                                <div class="flex count border border-solid border-gray-300 p-2 h-11">
                                    <button data-rowid="' . $k . '" class="decrement flex-auto w-5 leading-none cart-minus" aria-label="button"  style="flex: auto;">-</button>
                                    <input type="number" min="1" max="' . $stock . '" step="1" value="' . $item['quantity'] . '" class="quantity__input flex-auto w-8 text-center focus:outline-none input-appearance-none card-quantity w-16">
                                    <button data-rowid="' . $k . '" class="increment flex-auto w-5 leading-none cart-plus" aria-label="button" style="flex: auto;">+</button>
                                </div>
