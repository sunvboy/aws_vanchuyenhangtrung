...
<div class="content">
    ...
    <form id="formMinus" class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('customer_payments.store_minus')); ?>" method="post" enctype="multipart/form-data">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/vanchuyenhangtrung.com/resources/views/customer/backend/customer_payments/minus.blade.php ENDPATH**/ ?>