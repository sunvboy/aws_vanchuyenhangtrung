                        ...
                        <div class="space-y-3" id="formData">
                            <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(!empty($link)): ?>
                                    <div class="space-y-3 ">
                                        <div class="grid grid-cols-1 ">
                                            <input type="text" value="<?php echo e($link); ?>" name="links[]">
                                        </div>
                                    </div>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/vanchuyenhangtrung.com/resources/views/customer/backend/customer_orders/edit.blade.php ENDPATH**/ ?>