            ...
            <div class="flex-1 overflow-x-hidden w-full md:w-auto order-1 md:order-2">
                <div class=" bg-white space-y-3 pb-[150px]">
                    <div class="flex items-center justify-between">
                        <h1 class="text-black font-bold text-xl">Giỏ hàng (<span class="cart_total_item"><?php echo e($data->count()); ?></span>)</h1>
                        <a href="<?php echo e(route('cartF.create')); ?>" class="text-white bg_gradient font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 dark:bg-primary-600 outline-none focus:outline-none hover:outline-none">Thêm giỏ hàng</a>
                    </div>
                    <div class="space-y-3" id="table">
                        <?php if(!$data->isEmpty()): ?>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex rounded-lg bg-gray-100 p-5 space-x-4 col_<?php echo e($item->id); ?>">
                            <div class="w-5">
                                <label for="checkbox-item-quyen-<?php echo e($key); ?>" class="flex items-center cursor-pointer relative mt-1">
                                    <input type="checkbox" value="<?php echo e($item->id); ?>" id="checkbox-item-quyen-<?php echo e($key); ?>" class="w-5 h-5 rounded-full mt-1 cursor-default checkbox-item-quyen checkboxC">
                            ...
                            <div class="flex-1 space-y-2">
                                <div class="flex justify-between">
                                    <div class="flex-1 space-y-1">
                                        <div class="font-bold"><?php echo e($item->title); ?></div>
                                        <div><?php echo e(!empty($item->weight)?$item->weight:''); ?></div>
                                        <div>
                                            <span class="price_vnd_<?php echo $item->id ?>"><?php echo e(number_format($item->total * $cny->content,'0',',','.')); ?> VNĐ</span>
                                            (<span class="price_cny_<?php echo $item->id ?>">¥<?php echo e($item->total); ?></span>)
                                        </div>
                                    </div>
                                    <div>
                                        <a href="javascript:void(0)" class="flex items-center space-x-1 text-red-600 font-bold js_delete_cart" data-id="<?php echo e($item->id); ?>">
                                ...
                                <div class="custom-number-input h-10 w-32 flex flex-row rounded-lg relative bg-transparent mt-1">
                                    ...
                                    <input data-id="<?php echo e($item->id); ?>" type="number" class="tp_cardQuantity outline-none focus:outline-none text-center w-full bg-white font-semibold text-md hover:text-black focus:text-black md:text-basecursor-default flex items-center text-gray-700" name="custom-input-number" value="<?php echo e($item->quantity); ?>" />
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-6 flex-wrap gap-3">
                                    ...
                                    <?php if(!empty($img)): ?>
                                    <a href="<?php echo e(asset($img)); ?>" data-fancybox="images" rel='group<?php echo e($item->id); ?>'>
                                        <img src="<?php echo e(asset($img)); ?>" class="h-[70px] object-cover w-full" />
                                    </a>
                                    <?php endif; ?>
                                ...
                                <div>
                                    <ul>
                                        ...
                                        <?php if(!empty($link)): ?>
                                        <li><a href="<?php echo e($link); ?>" class="text-blue-500 hover:text-red-600" style="word-break: break-all;text-decoration: revert;" target="_blank"><?php echo e($link); ?></a></li>
                                        <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
                    ...
                    <div class="flex justify-between items-center overflow-x-hidden w-full md:w-full order-1 md:order-2 py-5 text-white bg_gradient p-4 md:rounded-lg">
                        <div class="flex flex-col space-y-1">
                            ...
                            <div>
                                ...
                                <div>Tổng tiền(CNY): <span class="font-bold total_price_cny"><?php echo e($data->sum('total')); ?></span> ¥</div>
                                <div>Tổng tiền(VNĐ): <span class="font-bold total_price_vnd"><?php echo e(number_format($data->sum('total')*$cny->content,'0',',','.')); ?></span> VNĐ</div>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\vanchuyenhangtrung.local\resources\views/customer/frontend/cart/cart.blade.php ENDPATH**/ ?>