...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('packaging_v_n_s.store')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <tbody id="list">
                            ...
                            if (isset($products) && is_array($products) && count($products)) { ?>
                                ...
                                <?php foreach ($products as $key => $val) { ?>
                                    ...
                                    <tr class="tr-<?php echo e(!empty($val) ? $val : ''); ?>">
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)" class="js_removeColumn text-danger font-bold" data-code="<?php echo e(!empty($val) ? $val : ''); ?>">Xóa</a>
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/api/resources/views/packaging/vietnam/create.blade.php ENDPATH**/ ?>