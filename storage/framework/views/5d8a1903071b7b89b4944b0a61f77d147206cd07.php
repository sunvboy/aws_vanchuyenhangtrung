<?php $__env->startSection('content'); ?>
    <main class="my-5">
        <div class="container mx-auto px-4 space-y-5">
            <h1 class="font-bold uppercase text-2xl"><a href="<?php echo e(route('deliveryHome.search')); ?>">Chi tiết đơn
                    giao <?php echo e($detail->code); ?></a></h1>
                        ...
                        <div class="overflow-hidden space-y-5">
                            <table class="min-w-full text-center text-sm font-light">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e(number_format($detail->shipping,'0',',','.')); ?>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quyenitc/vanchuyenhangtrung.com/resources/views/delivery/frontend/detail.blade.php ENDPATH**/ ?>